...
/*
  Structure used to manage connection string parsing.

  A connection string consists of one or more parameter definitions using
...
typedef struct st_spider_connect_string_parse
{
  char *start_ptr;         /* Pointer to the start of the connection string */
  char *end_ptr;           /* Pointer to the end   of the connection string */
  ...
  /**
    Initialize the connection string parse information.

    @param  connect_string    Pointer to the connection string being parsed.
  */

  inline void init(char *connect_string)
  {
  ...
  */
  ...
  /**
    ...
    title in the connection string.  Also save the parameter title's
    delimiter character.
  ...
  */
  ...
  /**
    Save pointers to the start and end positions of the current parameter
    value in the connection string.  Also save the parameter value's
    delimiter character.
  ...
  */
  ...
  /**
    Determine whether the current parameter in the connection string has
    extra parameter values.

    @return   0               Current parameter value in the connection string
                              does not have extra parameter values.
              <> 0            Error code indicating that the current parameter
                              value in the connection string has extra
                              parameter values.
  */
  ...
  /**
    ...
    connection string.  They were NULLed during parameter parsing.
  */
  ...
  /**
    Print a connection string parameter error message.

    @return                   Error code.
  */

  int print_param_error();
} SPIDER_CONNECT_STRING_PARSE;
...
char *spider_get_string_between_quote(
  char *ptr,
  bool alloc,
  SPIDER_CONNECT_STRING_PARSE *connect_string_parse = NULL
);
...
int spider_create_string_list(
  ...
  char *str,
  uint length,
  SPIDER_CONNECT_STRING_PARSE *connect_string_parse
);
